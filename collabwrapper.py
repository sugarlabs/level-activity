...
class CollabWrapper(GObject.GObject):
    ...
    def __init__(self, activity):
        _logger.debug('CollabWrapper.__init__')
    ...
    def setup(self):
        ...
        .. note::
            ...
            `__init__` function.
        '''
        _logger.debug('CollabWrapper.setup')
    ...
    def __shared_cb(self, sender):
        ...
        _logger.debug('CollabWrapper.__shared_cb')
    ...
    def __joined_cb(self, sender):
        ...
        _logger.debug('CollabWrapper.__joined_cb')
        self.shared_activity = self.activity.shared_activity
    ...
    def _setup_text_channel(self):
        ...
        _logger.debug('CollabWrapper._setup_text_channel')
    ...
    def _listen_for_channels(self):
        _logger.debug('CollabWrapper._listen_for_channels')
    ...
    def __new_channels_cb(self, channels):
        _logger.debug('CollabWrapper.__new_channels_cb')
        conn = self.shared_activity.telepathy_conn
    ...
    def _handle_ft_channel(self, conn, path, props):
        _logger.debug('CollabWrapper._handle_ft_channel')
    ...
    def __notify_ft_state_cb(self, ft, pspec):
        _logger.debug('CollabWrapper.__notify_ft_state_cb')
    ...
    def __received_cb(self, buddy, msg):
        ...
        _logger.debug('CollabWrapper.__received_cb')
        action = msg.get('action')
